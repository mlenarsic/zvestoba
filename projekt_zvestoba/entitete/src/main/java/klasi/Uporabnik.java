...
@NamedQueries(value =
        {
                @NamedQuery(name = "klasi.Uporabnik.getAll", query = "SELECT u FROM uporabnik u"),
                @NamedQuery(name="klasi.Uporabnik.getByIme",
                        query="SELECT u FROM uporabnik u WHERE u.ime = :name"),
                @NamedQuery(name="klasi.Uporabnik.getById",
                        query="SELECT u FROM uporabnik u WHERE u.id = :id"),
                @NamedQuery(name="klasi.Uporabnik.getNew",
                        query="SELECT u FROM uporabnik u WHERE u.id > :id")
