...
@NamedQueries(value =
        {
                @NamedQuery(name = "klasi.Storitev.getAll", query = "SELECT s FROM storitev s"),
                @NamedQuery(name = "klasi.Storitev.getByNaziv",
                        query = "SELECT s FROM storitev s where s.naziv = :naziv"),
                @NamedQuery(name = "klasi.Storitev.getByPonudnik",
                        query = "SELECT s FROM storitev s where s.ponudnikId = :pid"),
                @NamedQuery(name = "klasi.Storitev.getTopStoritve",
                        query = "SELECT s FROM storitev s where s.tocke > :tocke ORDER BY s.tocke"),
                @NamedQuery(name = "klasi.Storitev.getById",
